...
describe('Address tests', function() {
    ...
    it('renders and displays the default street', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').street
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default city', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').city
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default state', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').state
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default zip', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').zip
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default phone', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').phone
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default website', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').website
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default email', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').email
        ).toEqual('unknown');
    });
    ...
    it('renders and displays the default contact', () => {
        ...
        expect(
            wrapper.find('WithStyles(AddressShow)').prop('name').contact
        ).toEqual('unknown');
    });
    ...
    it('renders state of street after button click', () => {
        ...
        afterClickFieldTest(wrapper, () => {
            expect(addressProp(wrapper).firstName).toEqual(
    ...
    it('renders state of city after button click', () => {
        ...
        afterClickFieldTest(wrapper, () => {
            expect(addressProp(wrapper).firstName).toEqual('Washington DC');
        });
    });
    ...
    it('renders state of state after button click', () => {
        ...
        afterClickFieldTest(wrapper, () => {
            expect(addressProp(wrapper).firstName).toEqual('WA');
        });
    });
    ...
    it('renders state of zip after button click', () => {
        ...
        afterClickFieldTest(wrapper, () => {
            expect(addressProp(wrapper).firstName).toEqual(' 20510');
        });
    });
    ...
    it('renders state of phone after button click', () => {
        ...
        afterClickFieldTest(wrapper, () => {
            expect(addressProp(wrapper).firstName).toEqual('202-224-2621');
        });
    });
