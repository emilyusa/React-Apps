        ...
        fetch('/address-list')
            ...
            .then(addressListFromServer => {
                if (!this.canceled) {
                    ...
                    this.setState({
                        addressList: addressListFromServer.result
                    });
        ...
        return (
            <div className={classes.root}>
                <Paper className={classes.rootBar} elevation={4}>
                    ...
                    <Typography variant="body1" gutterBottom align="left">
                        If you clear the data in storage then refresh the app
                        before trying to do anything else. Use the sync button
                        when you are connceted to the Internet. By default, you
                        are not in sync mode. Do not press this button if you
                        are offline.
                    </Typography>
