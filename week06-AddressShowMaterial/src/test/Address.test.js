...
describe('Address tests', function() {
    ...
    it('renders and displays the default State', () => {
        const wrapper = shallow(<Address />);
        expect(wrapper.find('AddressShow').prop('address').somestate).toEqual(
            'unknown'
        );
    });
    ...
    it('renders state of State after button click', () => {
        ...
        setImmediate(() => {
            wrapper.update();
            expect(
                wrapper.find('AddressShow').prop('address').somestate
            ).toEqual('WA');
        });
    });
    ...
    it('renders and displays the default postal', () => {
        const wrapper = shallow(<Address />);
        expect(wrapper.find('AddressShow').prop('address').postal).toEqual(
            'unknown'
        );
    });
